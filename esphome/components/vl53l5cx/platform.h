 ...
 *     -> #include "vl53l5cx_buffers.h"  (uses NB_TARGET_PER_ZONE for buffer sizes)
 *
 * VL53L5CX_NB_TARGET_PER_ZONE must therefore be defined HERE, before
 * vl53l5cx_buffers.h is included by vl53l5cx_api.h.
 */
...
/* Typedef required — ST driver C files use 'VL53L5CX_Platform' without 'struct' prefix */
typedef struct {
